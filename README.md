...
This application processes location data for proximity matching purposes only. No personal information is stored or linked to users. All processing is anonymous using hashed identifiers.
